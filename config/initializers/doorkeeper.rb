...
Doorkeeper.configure do
  optional_scopes *ApiSettings::USER_SCOPES
  ...
  resource_owner_authenticator do
    ...
    current_user || redirect_to(new_user_session_url(next: request.original_url))
  end
  ...
  after_successful_authorization do |controller, context|
    Doorkeeper::TrackTokenCreation.call(context: context) if context.auth.is_a?(::Doorkeeper::OAuth::TokenResponse)
  end
